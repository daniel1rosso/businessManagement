...
<div class="page-content">
    ...
    <form id="formConfiguracionSistema" role="form" action="#" method="POST" enctype="multipart/form-data">
        <div class="panel panel-default">
            <div class="panel-heading"><h6 class="panel-title"><i class="fas fa-cog fa-lg fa-spin"></i> Configuración basica</h6></div>
                        ...
                        <div class="col-md-6" style="padding:0px;">
                            <div class="col-md-12">                                
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputNombreEmpesa_formConfiguracionSistema" id="inputNombreEmpesa_formConfiguracionSistema" type="text" class="form-control" value="<?= $empresa[0]["nombreSistema"] ?>">
                            ...
                            <div class="col-md-12">                                
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputCuit_formConfiguracionSistema" id="inputCuit_formConfiguracionSistema" data-minlength="9" maxlength="13" type="number" class="form-control" value="<?= $empresa[0]["cuit"] ?>" onkeyup="formato_cuit_config_sistema()" placeholder="0">
                            ...
                            <div class="col-md-12">  
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputCorreo_formConfiguracionSistema" id="inputCorreo_formConfiguracionSistema" maxlength="150" type="email" class="form-control" required value="<?= $empresa[0]["email"] ?>">
                            ...
                            <div class="col-md-12">  
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputDomicilio_formConfiguracionSistema" id="inputDomicilio_formConfiguracionSistema" data-minlength="3" maxlength="50" type="text" class="form-control" required  value="<?= $empresa[0]["direccion"] ?>">
                            ...
                            <div class="col-md-12">  
                                <div class="form-group label-floating has-feedback"> 
                                    <div id="boxCabeceraForm" style="margin-left: 15px;">
                                        <h3>
                                            <small>
                        ...
                        <div class="col-md-6" style="padding:0px;"> 
                            <div class="col-md-12">                                
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputInicioActividad_formConfiguracionSistema" id="inputInicioActividad_formConfiguracionSistema" data-minlength="2" maxlength="25" type="text" class="form-control" autocomplete="off"  value="<?= $empresa[0]["inicioActividad"] ?>">
                            ...
                            <div class="col-md-12">                                
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputIibb_formConfiguracionSistema" id="inputIibb_formConfiguracionSistema" type="text" class="form-control"  value="<?= $empresa[0]["iibb"] ?>" placeholder="0">
                            ...
                            <div class="col-md-4">                                
                                <div class="form-group label-floating has-feedback">   
                                    ...
                                    <input name="inputPuntoVenta_formConfiguracionSistema" id="inputPuntoVenta_formConfiguracionSistema" data-minlength="2" maxlength="25" type="number" class="form-control" value="<?= $empresa[0]["puntoVta"] ?>">
                            ...
                            <div class="col-md-6">  
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputNumTel_formConfiguracionSistema" id="inputNumTel_formConfiguracionSistema" data-minlength="10" maxlength="15" type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57)
                                                event.returnValue = false;" class="form-control" required value="<?= $empresa[0]["tel"] ?>">
                            ...
                            <div class="col-md-6">  
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <input name="inputNumCel_formConfiguracionSistema" id="inputNumCel_formConfiguracionSistema" data-minlength="10" maxlength="15" type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57)
                                                event.returnValue = false;" class="form-control" required value="<?= $empresa[0]["cel"] ?>">
                            ...
                            <div class="col-md-6">                              
                                ...
                                <input type="hidden" id="localidad_formConfiguracionSistema" value="<?= $empresa[0]["idLocalidad"] ?>" class="form-control">
                            <input type="hidden" id="id_formConfiguracionSistema" name="id_formConfiguracionSistema" value="<?= $empresa[0]["idEmpresa"] ?>" class="form-control">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h6 class="panel-title"><i class="fas fa-cog fa-lg fa-spin"></i> Configuración del negocio</h6></div>
            <div class="panel-body">
                <div id="paso-1" style="padding-bottom:15px;">
                    <div class="col-md-12" style="padding-bottom:15px;">
                        <div id="boxCabeceraForm">
                            <h3>
                                <small>
                                    <i style="color:#333333;" class="fas fa-file-invoice" aria-hidden="true"></i>
                        ...
                        <div class="col-md-4">                                
                            <div class="form-group label-floating has-feedback"> 
                                ...
                                <select name="selectFacturaElectronica_formConfiguracionSistema" id="selectFacturaElectronica_formConfiguracionSistema" class="select-full" required>
                            ...
                            <div class="col-md-6" style="padding:0px;">
                                <div class="col-md-12" style="padding: inherit;">                                
                                    <div class="form-group label-floating has-feedback"> 
                                        ...
                                        <input name="inputRazonSocial_formConfiguracionSistema" id="inputRazonSocial_formConfiguracionSistema" data-minlength="2" maxlength="25" type="text" class="form-control" value="<?= $empresa[0]["razonSocial"] ?>">
                                ...
                                <div class="col-md-12" style="padding: inherit;">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input name="inputToken_formConfiguracionSistema" id="inputToken_formConfiguracionSistema" data-minlength="2" maxlength="25" type="text" class="form-control" value="<?= $empresa[0]["token"] ?>">
                            ...
                            <div class="col-md-6" style="padding:0px;">
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input name="inputCertificado_formConfiguracionSistema" id="inputCertificado_formConfiguracionSistema" data-minlength="2" maxlength="25" type="text" class="form-control" value="<?= $empresa[0]["certificado"] ?>">
