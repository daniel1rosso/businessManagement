...
class ConfiguracionEcommerce extends MY_Controller {

    protected $data = array(
        'active' => 'ConfiguracionEcommerce'
    );
    ...
    public function listar_configuracion_ecommerce() {
        ...
        $this->load_view('configuracionEcommerce/listar_configuracion_ecommerce', $this->data);
    }

    public function configuracion_ecommerce() {
        header("Access-Control-Allow-Origin: *");
        header('Access-Control-Allow-Credentials: true');
