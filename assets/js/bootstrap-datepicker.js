		...
		set: function() {
			...
			if (!this.isInput) {
				...
				this.element.data('date', formated);
                                ...
                                //-- Fecha Adhesion - Home --//
                                $('#boxFechaNacAdhesion').removeClass('form-group label-floating has-feedback is-empty has-success');
                                $('#boxFechaNacAdhesion').addClass('form-group label-floating has-feedback has-success');
                                
                                $('#iconBoxFechaNacAdhesion').removeClass('glyphicon form-control-feedback glyphicon-remove');
                                $('#iconBoxFechaNacAdhesion').addClass('glyphicon form-control-feedback glyphicon-ok');
                                $("#iconBoxFechaNacAdhesion" ).css("color", "#4CAF50" );
                                //---//
